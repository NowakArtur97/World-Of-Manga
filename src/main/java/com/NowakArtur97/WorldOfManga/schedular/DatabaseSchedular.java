...
public class DatabaseSchedular {
	...
	public void onStartup() throws LanguageNotFoundException, MalformedURLException, MangaGenreNotFoundException {
		...
		action = mangaGenreService.findByEnglishTranslation("Action");
		adventure = mangaGenreService.findByEnglishTranslation("Adventure");
		comedy = mangaGenreService.findByEnglishTranslation("Comedy");
		...
		supernatural = mangaGenreService.findByEnglishTranslation("Supernatural");
		superPower = mangaGenreService.findByEnglishTranslation("Super Power");
		psychological = mangaGenreService.findByEnglishTranslation("Psychological");
		romance = mangaGenreService.findByEnglishTranslation("Romance");
		horror = mangaGenreService.findByEnglishTranslation("Horror");
